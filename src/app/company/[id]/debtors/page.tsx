...
function getPartyInvoices(
  ...
  for (const e of entries) {
    for (const line of e.lines) {
      ...
      if (!['Trade Receivables', 'Sundry Debtors'].includes(line.account_group)) continue;
...
export default function DebtorsPage() {
  ...
  const ageingRows = useMemo(() => {
    ...
    return computeDebtorAgeing(entries, today, 'schedule_iii')
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Debtors" description="Trade receivables — per-party outstanding and ageing" />
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          ...
          <p className={`mt-1 font-mono text-2xl font-bold tabular-nums ${over6m > 0 ? 'text-red-600' : 'text-gray-900'}`}>
            <span className="text-sm text-gray-400">&#8377;</span>{inr(over6m)}
          </p>
          <p className="mt-0.5 text-[11px] text-gray-500">Requires attention</p>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Parties</p>
      ...
      <div className="rounded-xl border border-gray-200 bg-white">
        <div className="flex items-center justify-between border-b border-gray-100 px-4 py-2.5">
          <h3 className="text-sm font-bold text-gray-800">Debtors Ageing (Schedule III)</h3>
              ...
              {ageingRows.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-xs text-gray-400">
                    No outstanding debtors. All receivables are settled.
                  </td>
                </tr>
              ) : (
                <>
        ...
        <>
          ...
          <div className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col border-l border-gray-200 bg-white shadow-2xl">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Debtor Details</p>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-5">
              ...
              <div className="rounded-lg border border-gray-100 bg-gray-50/50 p-4 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-gray-700">Total Outstanding</span>
